...
## [0.0.2] - 24.01.2023
### Добавлено:
* AddressableSceneLoadWrapper. Реализация абстрактного класса LoadSceneWrapper. В методе Load создает связку Model-Presenter. Далее вызывается метод Init у Presenter'a, который производит загрузку сцены с помощью Addressables. По окончании загрузки, создается LocationLogicBuilder, инициализирующий верзхнеуровневую связку Model-Presenter конкретной локации.
